...
int buttonState;
#define speedPinRight 5    // Left PWM pin connect MODEL-X ENA
#define dir1PinRight   7  // Right Motor direction pin 1 to MODEL-X IN1
#define dir2PinRight  8   // Right Motor direction pin 2 to MODEL-X IN2
#define speedPinLeft 6   //RIGHT PWM pin connect MODEL-X ENB
#define dir1PinLeft  9    //Left Motor direction pin 1 to MODEL-X IN3
#define dir2PinLeft 10    //Left Motor direction pin 2 to MODEL-X IN4
   //back speed
